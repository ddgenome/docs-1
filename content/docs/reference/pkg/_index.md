...
<div class="tiles">
    <a class="tile flex-1" href="{{< relref "/docs/reference/pkg/aws" >}}">
        <img class="h-10 mx-auto" src="/logos/tech/aws.svg" alt="AWS">
    </a>
    <a class="tile flex-1 md:mx-4 my-4 md:my-0" href="{{< relref "/docs/reference/pkg/azure" >}}">
        <img class="h-10 mx-auto" src="/logos/tech/azure.svg" alt="Azure">
    </a>
    <a class="tile flex-1" href="{{< relref "/docs/reference/pkg/gcp" >}}">
